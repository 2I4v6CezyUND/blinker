...
RSpec.describe VehiclesController, type: :controller do
  ...
  let(:f150XL) { FactoryBot.create(:model_variant, :F150XL, model: f150) }
  let(:valid_attributes) {
    FactoryBot.build(:vehicle, model_variant: f150XL, description: "not sure but its great").attributes
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested vehicle" do
        ...
        vehicle.reload
	expect(vehicle.description).to eql("Needs some TLC")
      end
